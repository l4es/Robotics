...
#include "intviewermodule.h"

#include <qlabel.h>

#include <rdkcore/logging/logging.h>
#define LOGGING_MODULE "IntViewerModule"

#include <rdkcore/rprimitive/rint.h>

namespace RDK2 { namespace RConsoleQt {
	
QWidget* IntViewerModule::createWidget()
{
	string myUrl = "<error>";
...
RDK2::Object* IntViewerModule::buildRObject()
{
	RDK2::Object* obj = new RInt();
...
void IntViewerModule::refreshWidgetFields()
{
	QT_THREAD_GUARD()
...
MODULE_FACTORY(IntViewerModule);
