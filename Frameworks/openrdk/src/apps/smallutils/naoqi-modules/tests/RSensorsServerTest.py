"""
  UnitTests for RSensorsServer Module
...
class RSensorsServerTest(unittest.TestCase):
    """
...
def main():
    global proxy
    proxy = ALProxy("RSensorsServer", IP, PORT)
    suite = unittest.TestLoader().loadTestsFromTestCase(RSensorsServerTest)
