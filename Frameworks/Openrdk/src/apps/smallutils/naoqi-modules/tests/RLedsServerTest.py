"""
  UnitTests for RLedsServer Module
...
class RLedsServerTest(unittest.TestCase):
    """
...
def main():
    global proxy
    proxy = ALProxy("RLedsServer", IP, PORT)
    suite = unittest.TestLoader().loadTestsFromTestCase(RLedsServerTest)
