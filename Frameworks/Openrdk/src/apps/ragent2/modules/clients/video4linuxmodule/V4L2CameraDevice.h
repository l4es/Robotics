...
public:
     ...
     */
    //@{
    virtual void init(uint type, int width, int height, int fps, IOMethod iom=IO_METHOD_MMAP, bool do_setting=true);
    virtual void init() { init(V4L2_PIX_FMT_RGB24,DEFAULT_WIDTH,DEFAULT_HEIGHT,DEFAULT_FPS,IO_METHOD_MMAP,true); }
    //@}
    /**
