 ...
 * \ingroup LinkedList
 */
#define listLIST_IS_EMPTY( pxList )				( (unsigned int)(( pxList )->uxNumberOfItems) == ( unsigned int ) 0 )
 ...
 * \ingroup LinkedList
 */
#define listGET_OWNER_OF_NEXT_ENTRY( pxTCB, pxList, pxType )									\
{																						\
xList * const pxConstList = pxList;														\
	...
	pxTCB = (pxType)( pxConstList )->pxIndex->pvOwner;											\
}
