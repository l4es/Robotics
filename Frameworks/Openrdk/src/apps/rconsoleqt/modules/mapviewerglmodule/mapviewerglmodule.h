...
#ifndef RDK2_RQM_MAPVIEWERGLMODULE
#define RDK2_RQM_MAPVIEWERGLMODULE
...
#define PROPERTY_MAP_URLS "params/mapUrls"
#define PROPERTY_POSE_URLS "params/poseUrls"
#define PROPERTY_EDITING_POSE "params/editingPose"
#define PROPERTY_DRAWABLE_URLS "params/drawableUrls"
#define PROPERTY_CENTER_POSE "params/centerPose"
#define PROPERTY_CENTER_POSE_USE_ANGLE "params/centerPoseUseAngle"
#define PROPERTY_REFRESH_RATE "params/refreshRate"
#define PROPERTY_CLONE_MAP "params/cloneMap"
...
class MapViewerGlModule: public BigPropertyViewerModule {
Q_OBJECT
public:
	MapViewerGlModule() : posing(false), timerSaveToConfig(this), currentScale(100) { }
...
public slots:
	...
	void slot_btnRemoveShownPoseSelected_clicked();
