...
#ifndef SEARCHALGORITHMS_BESTFIRST
#define SEARCHALGORITHMS_BESTFIRST
...
class BestFirst : public AStar<UserStateClass> {
public:
	~BestFirst() { }

protected:
	virtual double computeCost(const UserStateClass& /*state1*/, const UserStateClass& /*state2*/) { return 0.; }
