...
#ifndef RDK2_RMAPS_RPATHREQUEST
#define RDK2_RMAPS_RPATHREQUEST
...
namespace RDK2 { namespace RMaps {
	...
	struct RPathRequest : public RDK2::Object {
		string id;
		Point2od startPose, targetPose;
	
		void read(Reader* r) throw (ReadingException);
		void write(Writer* w) const throw (WritingException);
		RDK2_DEFAULT_CLONE(RPathRequest);
	};
