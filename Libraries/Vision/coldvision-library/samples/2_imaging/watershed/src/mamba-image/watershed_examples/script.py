...
fileIndex = "8"
fileName = "watershed_test_"+fileIndex+".jpg"
fileNameOutPrefix = "watershed_out_"+fileIndex
dataDirectory = "../../../data/"

im = imageMb(dataDirectory+fileName)
...
im4.save(dataDirectory+fileNameOutPrefix+"_Mamba_Enhanced.jpg")
...
im4.save(dataDirectory+fileNameOutPrefix+"_Mamba_Standard_G20.jpg")
# Let's try with a smaller gain, like 1.5
# It produces what seems to be a better result
n = standardSegment(im2, im3, gain=1.5)
threshold(im3, im4, 0, n-1)
print("Standard algorithm, levels = %d" % (n))
im4.save(dataDirectory+fileNameOutPrefix+"_Mamba_Standard_G15.jpg")
...
threshold(im3, im4, 0, n-1)
print("Standard algorithm, levels = %d" % (n))
im4.save(dataDirectory+fileNameOutPrefix+"_Mamba_Standard_G10.jpg")
...
im4.save(dataDirectory+fileNameOutPrefix+"_Mamba_P_Algorithm.jpg")
...
im4.save(dataDirectory+fileNameOutPrefix+"_Mamba_Extended.jpg")
